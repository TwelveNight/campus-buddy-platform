...
const getTypeTagType = (type: string) => {
  const typeMap: Record<string, string> = {
    ...
    'GROUP_ADMIN_REMOVED': 'warning',
    'GROUP_STATUS': 'warning',
    'GROUP_STATUS_CHANGE': 'warning',
    'GROUP_DELETE': 'danger',
    'POST_COMMENTED': 'info',
...
const getTypeLabel = (type: string) => {
  const typeMap: Record<string, string> = {
    ...
    'GROUP_ADMIN_REMOVED': '管理员取消',
    'GROUP_STATUS': '小组状态变更',
    'GROUP_STATUS_CHANGE': '小组状态变更',
    'GROUP_DELETE': '小组删除',
    'POST_COMMENTED': '帖子评论',
