        ...
        <el-card v-loading="loading">
                ...
                <div class="card-header">
                    ...
                    <div class="header-actions" v-if="info && isPublisher">
                        <el-button-group>
                            ...
                            <el-button size="small" type="danger" :disabled="!canDelete"
            ...
            <div v-else-if="info" class="info-content">
                <el-descriptions :column="2" border>
                    ...
                    <el-descriptions-item label="发布时间">{{ info.createdAt }}</el-descriptions-item>
                    ...
                    <el-descriptions-item label="悬赏金额" v-if="info.rewardAmount">{{ info.rewardAmount }}
                            ...
                            <template #default="scope">
                                <el-button-group v-if="scope.row.status === 'PENDING'">
                                    <el-button size="small" type="success"
                                        @click="handleAcceptApplication(scope.row.id)">接受</el-button>
                                    <el-button size="small" type="danger"
                                        @click="handleRejectApplication(scope.row.id)">拒绝</el-button>
                                </el-button-group>
                                <span v-else>-</span>
                            </template>
                        </el-table-column>
...
import { deleteHelpInfo, updateHelpInfo } from '../api/helpinfo'
...
const isPublisher = computed(() => {
    ...
    return info.value.publisherUsername === authStore.user.username
})
